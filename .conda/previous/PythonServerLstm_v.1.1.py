...
# Read model
filepath = "./results/21/saved_models/best_model_Features_10.keras" # Timesteps: 10, Features: 6
...
def process_data(data_received):
    ...
    # Return block
    if result[0] > result[1] and result[0] > 0.7:
        return 3
    elif result[1] > result[0] and result[1] > 0.7:
        return 5
    else:
        return 0
